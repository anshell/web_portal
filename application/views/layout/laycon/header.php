                    ...
                    <nav class="navigation ts-main-menu navigation-landscape">
                        <div class="nav-header">
                            <a class="nav-brand" href="index.html">
                                <img src="images/logo/logo_v6.png" alt="">
                            </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-lg-4">
                                                        <div class="item">
                                                            ...
                                                            <div class="post-content">
                                                                <h3 class="post-title">
                                                                    <a href="#">Can't shed those Gym? The problem might
                                                                        be in</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-12 col-lg-4">
                                                        <div class="item">
                                                            ...
                                                            <div class="post-content">
                                                                <h3 class="post-title">
                                                                    <a href="#">Smart packs parking sensor tech and
                                                                        beeps</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-12 col-lg-4">
                                                        <div class="item">
                                                            ...
                                                            <div class="post-content">
                                                                <h3 class="post-title">
                                                                    <a href="#">Deleting fears from the brain means you
                                                                        might never</a>
                                                                </h3>
                                                            </div>
                                                        </div>
