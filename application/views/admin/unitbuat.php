                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url() . 'admin/unitkerja/simpan'; ?>" method="POST">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">
                                                <select data-plugin="customselect" name="id_kunit" class="form-control" required data-placeholder="Select an option">
                                                    ...
                                                    ?>
                                                        ...
                                                        <option value="<?php echo $r->id_kunit ?>"><?php echo $r->nama_unit ?></option>
                                                    <?php } ?>

                                                </select>

                                            </div> <small class="text-danger p-2"><?= form_error('id_kunit') ?></small>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select data-plugin="customselect" name="id" class="form-control" required data-placeholder="Select an option">
                                                    ...
                                                    ?>
                                                        ...
                                                        <option value="<?php echo $r->id ?>"><?php echo $r->nama ?> - <?php echo $r->nip ?></option>
                                                    <?php } ?>
