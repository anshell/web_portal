                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label" for="example-textarea">Nama Lengkap OPD </label>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label" for="example-textarea">Nama Pendek OPD </label>
                        ...
                        <div class="card-body">
                            ...
                            <?php foreach ($opd as $r) { ?>
                                ...
                                <form class="form-horizontal" action="<?php echo site_url() . 'admin/pengaturan/profilopd/ubahlogo'; ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-12">
                                        <h6 class="header-title mt-0">Update Logo OPD</h6>
                                    </div>
