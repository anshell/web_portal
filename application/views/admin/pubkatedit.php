                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php foreach ($pubkat as $r) { ?>

                                <form class="form-horizontal" action="<?php echo base_url() . 'admin/publikasi/kategori/update'; ?>" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class=" form-group row">
                                                <a href="<?= site_url('admin/publikasi/kategori') ?>" class="btn btn-secondary btn-sm">Batal</a>&nbsp;&nbsp;
