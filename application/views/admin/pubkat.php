    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    <center>
                                                        <a href="<?= site_url('admin/publikasi/kategori/edit/') . $r->id_kat ?>" class="text-info d-inline-block " data-toggle="tooltip" data-placement="top" title="" data-original-title="edit data">
                ...
                <div class="col-lg-6">
                    <form action="<?php echo base_url() . 'admin/publikasi/kategori/simpan'; ?>" method="POST">
                        <div class="card">
                            <div class="card-body">
