                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php echo form_open("admin/profil/simpan_pengelola", array('enctype' => 'multipart/form-data')); ?>
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <input type="file" class="form-control" name="input_gambar" placeholder="Foto" required>
                                        </div>
                                    </div>
