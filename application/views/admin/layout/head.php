...
<head>
    ...
    <!-- plugins -->
    <link href="<?= base_url('assets/'); ?>assets/libs/flatpickr/flatpickr.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url('assets/'); ?>assets/libs/summernote/summernote-bs4.css" rel="stylesheet" />
    <!-- App css -->
