                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate action="<?php echo base_url() . 'admin/berita/posting'; ?>" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-2 col-form-label" for="example-textarea">Foto Berita <span class="text-info">(900x700)</span> </label>
