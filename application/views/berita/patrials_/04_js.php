...
<!--Parallax Background-->
<script src="<?= base_url('assets/'); ?>js/parallaxie.min.js"></script>
<!-- Fancy Box JS File -->
...
<script src="<?= base_url('assets/'); ?>js/revolution/jquery.themepunch.revolution.contdown.min.js"></script>

<!-- Before After Effect Slider Revolution -->
<script src="<?= base_url('assets/'); ?>js/revolution/revolution.addon.particles.min.js"></script>
<script src="<?= base_url('assets/'); ?>js/revolution/revolution.addon.beforeafter.min.js"></script>
...
<!-- Google Map Api -->
<script src="<?= base_url('assets/'); ?>https://maps.googleapis.com/maps/api/js?key=AIzaSyDJScy7qJ156DWM8kJVG-ZrK0R7Kize2Jg "></script>
<script src="<?= base_url('assets/'); ?>js/maps.min.js"></script>
